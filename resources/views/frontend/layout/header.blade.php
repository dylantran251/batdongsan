<nav class="hidden relative lg:block lg:w-100 shadow bg-[#FAFAFA] border-b border-[#dfdfdf] py-1" >
    <div class="flex justify-between items-center mx-5 xl:container xl:mx-auto xl:px-20">
        <a href="#" class="flex items-center text-base   text-[#828282] gap-2" style="font-weight:bold">
