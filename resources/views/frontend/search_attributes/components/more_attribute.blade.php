<div class="w-full relative">
    ...
    <div class="dropdown-box hidden w-[400px] {{ $style === 0 ? 'mt-2' : 'mt-4' }} absolute right-0 z-10 text-base text-black bg-white rounded-lg shadow-lg shadow-lg">
        <div class="p-4">
            ...
            <div class="flex flex-col gap-3 mb-5">
                <h3 class=" text-base ">Số nhà vệ sinh</h3>
                <ul class="flex space-x-4">
                    @foreach (config('filter_params.room') as $value)
                        <li data-number = "{{ $value }}" class="choose-toilet cursor-pointer text-gray-900 bg-gray-200 p-2 px-4 rounded-full hover:bg-[#FFD8C2] hover:text-[#74150F]
            ...
            <div class="flex flex-col gap-3 mb-5">
                <h3 class=" text-base ">Hướng nhà</h3>
