...
class User extends Authenticatable
{
    ...
    protected $appends = ['photoUrl', 'role', 'actions'];
    /**
    ...
    public function getActionsAttribute()
    {
        if ($this->role != 'admin')
            return '<div class="flex lg:justify-center items-center">
                            <a class="edit flex items-center mr-3" href="javascript:;" data-update-url="'.route('admin.users.update', $this).'" data-get="'.route('admin.users.getItem', $this).'" data-tw-toggle="modal" data-tw-target="#edit-user-modal" >
                            ...
                            <a class="delete flex items-center text-danger" href="javascript:;" data-url="'.route('admin.users.destroy', $this).'"
